...
export const paypalCheckPayment = async (transactionId: string) => {
    ...
    if(!authToken) {
        return {
            ok: false,
            message: 'could not get the access token'
        }
    }
    ...
    try {
        ...
        //- Revalidamos el path que estamos
        ...
        return {
            ok: false, 
            message: '500 - The payment could not be completed'
        }
    }

}

//? ----- Funcion solo para Generar el token de acceso
...
// ? ----- Funcion para verificar el pago en paypal
